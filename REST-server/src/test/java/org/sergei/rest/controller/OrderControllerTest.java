...
public class OrderControllerTest {
    ...
    public void findAllOrders_thenReturnOk() throws Exception {
        ...
        mvc.perform(
                ...
                .andExpect(jsonPath("$[0].orderDate").value("2018-09-28T22:00:00"))
                .andExpect(jsonPath("$[0].requiredDate").value("2018-09-29T22:00:00"))
                .andExpect(jsonPath("$[0].shippedDate").value("2018-09-30T22:00:00"))
