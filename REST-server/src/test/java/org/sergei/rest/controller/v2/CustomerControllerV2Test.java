...
/**
 * Test for {@link CustomerControllerV2}
 *
...
public class CustomerControllerV2Test {
    ...
    private static final String BASE_URL_V1 = "http://localhost/api/v1/customers";
    ...
    public void getAllCustomers_thenReturnOk() throws Exception {
        ...
        mvc.perform(
                ...
                .andExpect(jsonPath("$._embedded.customerDTOV2List[0].customerId").isNotEmpty())
                .andExpect(jsonPath("$._embedded.customerDTOV2List[0].firstName").value(firstName))
                .andExpect(jsonPath("$._embedded.customerDTOV2List[0].lastName").value(lastName))
                .andExpect(jsonPath("$._embedded.customerDTOV2List[0].age").value(age))
                .andExpect(jsonPath("$._embedded.customerDTOV2List[0]._links.self.href", is(BASE_URL + "/" + customer.getCustomerId())))
