...
public class CustomerService {
    ...
    private static final String REST_RESORUSE_URI = "http://localhost:9091/api";
    ...
    public ResponseEntity<Customer> getCustomerByNumber(Long customerId) {
        ...
        ResponseEntity<Customer> customerResponseEntity =
                restTemplate.exchange(REST_RESORUSE_URI + "/v1/customers/" + customerId + ACCESS_TOKEN + tokenInfo.getAccessToken(),
